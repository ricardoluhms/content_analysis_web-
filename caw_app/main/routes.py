...
from caw_app.main.forms import EditProfileForm, EmptyForm, PostForm, SearchForm, \
    MessageForm
from caw_app.models import User, Post #, Message, Notification
...
def index():
    ...
    next_url = url_for('templates.index', page=posts.next_num) \
        if posts.has_next else None
    prev_url = url_for('templates.index', page=posts.prev_num) \
